...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      // The design system in styles.css names three faces — Space Grotesk (display),
      // IBM Plex Sans (UI), IBM Plex Mono (money). Without these they all silently fell
      // back to system-ui, which is why the console read as unstyled.
